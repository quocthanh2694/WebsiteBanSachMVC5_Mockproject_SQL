...
namespace Vinabook.Models
{
    ...
    public partial class QuanLyBanSachEntities : DbContext
    {
        ...
        public virtual ObjectResult<ThongKeDoanhThuTheoNam_Result> ThongKeDoanhThuTheoNam()
        {
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<ThongKeDoanhThuTheoNam_Result>("ThongKeDoanhThuTheoNam");
        }
    
        public virtual ObjectResult<ThongKeDoanhThuTheoThang_Result> ThongKeDoanhThuTheoThang(string nam)
        {
